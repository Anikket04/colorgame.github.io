...
<div class="container">
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#home">Mobile Payment</a></li>
        <!-- <li><a data-toggle="tab" href="#menu1">BANK</a></li> -->
    </ul>

<div class="tab-content">
  <div id="home" class="tab-pane fade in active">
        <h1><b>Step 1. <br> Take A Screen Short</b></h1>
        <div class="box" style="margin-bottom: 0;">        
            <p>
                <!--<span class="label">Upi Id.&nbsp;: (upi)
                <span class="label">UPI ID</span>
                <span class="value">md3895@paytm</span>
        
                <button class="btn copyBtn" data-clipboard-text="md3895@paytm">Copy</button></span>-->
            </p>
        <span class="img" ><img data-big-img="example3" src="/assets/img/sample/qr.png" width="300" height="300"></span>
...
<div>
<h1><b>Step 2.<br> Open Phpne pe/Google pay/Paytm/Bhim app and Scan Screen Short Qr Code</b></h1>
</div>
...
<form class="paymentRefForm" action="" method="POST" autocomplete="off">
    <div class="form-group">
        ...
        <div><span style="color:#0081FF; font-size:12px;">* copy UTR/reference number from your transaction and paste here</span></div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" name="email" placeholder="Enter Payment Mobile Number" required>
    </div>
...
<div class="img-row">
<img data-big-img="example1" class="ext" src="/assets/img/sample/small1.png">
<img data-big-img="example2" class="ext" src="/assets/img/sample/small2.png">
</div>
<div class="img-row">
<img data-big-img="example3" class="ext" src="/assets/img/sample/small3.png">
<img data-big-img="example4" class="ext" src="/assets/img/sample/small5.png">
</div>
