...
<a class="nav-link" id="contact-tab3" data-toggle="tab" href="#emerd" role="tab" onClick="tabname('emerd');getResultbyCategory('emerd','emerd');">Emerd</a> 
      ...
      <div class="divsize4">
      <button type="button" class="btn btn-lg btn-green gbutton none" onClick="betbutton('#05ff00','button','Green');">Join Green</button>
      </div>
      <div class="divsize4">
      <button type="button" class="btn btn-lg btn-violet0 gbutton none" onClick="betbutton('#8c0063','button','Violet');">Join Violet</button>
      </div>
      <div class="divsize4">
      <button type="button" class="btn btn-lg btn-red gbutton none" onClick="betbutton('red','button','Red');">Join Red</button>
      </div>
      </div>
     ...
     <div cla="container-fluid  ">
      ...
      <div class="divsize00">
      <button type="button" class="btn btn-lg gbutton none btn-violet-red" onClick="betbutton('#8c0063','button','0');">0</button>
      </div>
      <div class="divsize11">
      <button type="numbutton" class="btn btn-lg btn-green gbutton none" onClick="betbutton('#05ff00','button','1');">1</button>
      </div>
      
      <div class="divsize22">
      <button type="button" class="btn btn-lg btn-red gbutton none" onClick="betbutton('red','button','2');">2</button>
      </div>
      
      <div class="divsize11">
      <button type="button" class="btn btn-lg btn-green gbutton none" onClick="betbutton('#05ff00','button','3');">3</button>
      </div>
      
      <div class="divsize22">
      <button type="button" class="btn btn-lg btn-red gbutton none" onClick="betbutton('red','button','4');">4</button>
      </div>
      ...
      <div class="divsize55">
      <button type="button" class="btn btn-lg btn-violet-green gbutton none" onClick="betbutton('#8c0063','button','5');">5 </button>
      </div>
      
      <div class="divsize22">
      <button type="button" class="btn btn-lg btn-red gbutton none" onClick="betbutton('red','button','6');"> 6</button>
      </div>
      
      <div class="divsize11">
      <button type="button" class="btn btn-lg btn-green gbutton none" onClick="betbutton('#05ff00','button','7');">7 </button>
      </div>
      <div class="divsize22">
      <button type="button" class="btn btn-lg btn-red gbutton none" onClick="betbutton('red','button','8');"> 8</button>
      </div>
      <div class="divsize11">
      <button type="button" class="btn btn-lg btn-green gbutton none" onClick="betbutton('#05ff00','button','9');">9 </button>
      </div>
      </div>
