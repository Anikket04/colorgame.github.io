...
if($chkwithdrawalResult['status']==0){
        ...
        <tr>
          ...
          <div class="listitem">
          <div class="image">
              <div class="iconBox text-success bg-success"> 
              </div>
            
            <div class="text text-success"><img src="success.png" style="width:45px;height:45px;" />
...
<small>Pending..</small></td>
     ...
     <div class="text text-danger"><div><strong style="font-size:14px; color:red;">Withdrawal Failed </strong><small><?php echo $convert;?></small></div></div>
            </div>
            </td>
          <td class="tdtext text-danger">+<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
        <?php }?>
