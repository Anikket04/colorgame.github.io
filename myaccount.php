...
<div class="card-header">
            <h2 class="mb-0"> 
             <a href="#" class="btn btn-link collapsed"><i class="fa fa-download text-primary" style="font-size:16px"></i>
           Download App </a> </h2>
          </div>
<p style="color: white; font-size:11px;" ><strong>_____________________________________________________________________</p>            
<div class="card-header">
            <h2 class="mb-0"> 
             <a href="#" class="btn btn-link collapsed"><i class="fa fa-telegram text-primary" style="font-size:16px"></i>
           Support </a> </h2>
          </div>          
         </div>
      <!-- * listview --> 
